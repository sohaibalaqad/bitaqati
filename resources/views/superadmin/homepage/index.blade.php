...
<div class="page-header" style="display:flex;align-items:center;justify-content:space-between;margin-bottom:24px">
  ...
  <div style="display:flex;gap:10px">
    <a href="{{ route('superadmin.homepage.plans') }}" class="btn btn-outline" style="font-size:14px;padding:9px 18px">
...
<div id="sectionsList" style="display:flex;flex-direction:column;gap:14px">
  ...
  <div class="hp-card" data-id="{{ $section->id }}">
    ...
    <div class="hp-card-footer">
      <a href="{{ route('superadmin.homepage.edit', $section) }}" class="btn btn-outline" style="font-size:13px;padding:7px 14px">
      ...
      <form action="{{ route('superadmin.homepage.destroy', $section) }}" method="POST" style="margin-right:auto"
...
Sortable.create(list, {
  ...
  onEnd() {
    ...
    fetch('{{ route('superadmin.homepage.reorder') }}', {
      method: 'POST',
...
function toggleSection(id, btn) {
  fetch(`/superadmin/homepage/${id}/toggle`, {
    method: 'POST',
