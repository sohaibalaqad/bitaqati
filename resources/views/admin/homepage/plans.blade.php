...
.plan-table tr:hover td { background:rgba(14,165,233,.02); }
.popular-badge {
...
<div class="form-panel">
  ...
  <form action="{{ route('admin.homepage.plans.store') }}" method="POST">
    @csrf
        ...
        <tr>
          ...
          <td>
            <div style="display:flex;gap:8px;justify-content:flex-end">
              ...
              <form action="{{ route('admin.homepage.plans.destroy', $plan) }}" method="POST"
...
<div class="edit-modal" id="modal-{{ $plan->id }}">
  <div class="modal-box">
    ...
    <form action="{{ route('admin.homepage.plans.update', $plan) }}" method="POST">
      @csrf @method('PUT')
      <div class="field-row">
        <div class="field-group">
          <label>اسم الخطة <span style="color:#dc2626">*</span></label>
